...
| **Silniki** | PostgreSQL, SQL Server (dwie bazy albo dwa schematy) |
| **SQL** | [Postgres](../../sql/postgres/skalowanie/cqrs.sql) · [SQL Server](../../sql/sqlserver/skalowanie/cqrs.sql) |
...
- [Widok zmaterializowany](materialized-view.md) — CQRS „w silniku”, gdy starczy jedna instancja
- [Idempotencja](../integracja/idempotencja.md)
