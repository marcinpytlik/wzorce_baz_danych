...
| **SQL** | [skrypt](../../sql/wspolbieznosc/idempotencja.sql) |
...
[Inbox](../integracja/inbox.md) to specjalizacja: klucz = `MessageId`, zakres = konsument, zwykle bez replay body HTTP.

Unikalność biznesowa (`UNIQUE (KlientId, NumerFaktury)`) jest **drugą** linią — [unique jako strażnik](../../mechanizmy/unique-constraint.md) — nie zamiast klucza idempotency.
...
- [Unique constraint](../../mechanizmy/unique-constraint.md)
