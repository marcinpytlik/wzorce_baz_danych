...
--
-- Aplikacja czyta katalog, hasła z vault. TLS do instancji — nie wyłączaj szyfrowania „bo FCI”.
-- W bazie tenanta nie ma TenantId na każdej tabeli. Restore klienta = RESTORE tej bazy.
-- Osobna instancja / FCI to kolejny szczebel operacyjny, nie ten wzorzec.
